...
const Gallery = () => {
  ...
  <div class="col">
    <div class="card">
      <img src="/images/pro1.png" style={{borderRadius:"20px"}} class="card-img-top" alt="..."></img>
      
    </div>
  </div>
  <div class="col">
    <div class="card">
      <img src="/images/pro2.png" style={{borderRadius:"20px"}}  class="card-img-top" alt="..."></img>
  ...
  <div class="col">
    <div class="card">
      <img src="/images/pro4.png"  style={{borderRadius:"20px"}}  class="card-img-top" alt="..."></img>
      
    </div>
  </div>
  <div class="col">
    <div class="card">
      <img src="/images/p3.png" style={{borderRadius:"20px"}}  class="card-img-top" alt="..."></img>
      
    </div>
  </div>
  <div class="col">
    <div class="card">
      <img src="/images/p4.png" style={{borderRadius:"20px"}}  class="card-img-top" alt="..."></img>
      
    </div>
  </div>
  <div class="col">
    <div class="card">
      <img src="/images/p5.png" style={{borderRadius:"20px"}}  class="card-img-top" alt="..."></img>
      
    </div>
  </div>
  <div class="col">
    <div class="card">
      <img src="/images/p7.png" style={{borderRadius:"20px"}}  class="card-img-top" alt="..."></img>
      
    </div>
  </div>
  <div class="col">
    <div class="card">
      <img src="/images/4.png" style={{borderRadius:"20px"}}  class="card-img-top" alt="..."></img>
  ...
  <div class="col">
    <div class="card">
      <img src="/images/1.png" style={{borderRadius:"20px"}}  class="card-img-top" alt="..."></img>
      ...
      <div className="gallery">
          <div className='leftContent'>
              ...
              <p className='h6'> "DRESS YOUR WALLS IN DREAMS, PAINT YOUR SPACE WITH EMOTIONS – PALETTE DREAMS, YOUR ARTISTIC HAVEN!"</p>
                <br></br>
              <p className='h1'>ARTVISTA</p>

              <p className='ourstory'>"Welcome to Artvista – Your haven for abstract art! Step into a world where each painting becomes an unspoken dialogue, infusing a unique artistic ambiance into your life."
              </p><p className='ourstory'>
              "Our mission is to seamlessly integrate art into your everyday life through distinct and captivating abstract oil paintings. Each piece is born from the depths of creativity, designed to spark imagination and emotional resonance."
              </p>
